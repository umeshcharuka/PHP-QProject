...
<header>
	<div class="container">
			...
			<div class="col-md-6 intro-text hidden-sm hidden-xs wow animated fadeInUp">
				...
				<a href="#contact" class="btn btn-green">Post a question<span class="price">??</span></a>
			</div>
	</div>
</header>
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-right main-nav">
				...
				<li><a href="#contact" class="scrollto">Post a Question</a></li>
...
<section id="answer">
	<div class="container">
		<div class="row">
			...
			$sql1=" select * from question order by id DESC LIMIT 5";
 ...
 echo ""."".'<h2 class="subheading accent no-margin wow animated fadeInUp">'."".'<span class="glyphicon glyphicon-pencil">';
			 ...
			 echo '<p class="small wow animated fadeInUp">';
			 echo '<textarea disabled style="resize:both;border:none;background-color:white;  width:80%; height:50%;">';
			 echo "". $row2["comments"]."".""."";
			 echo '</textarea>';
			 echo '</p>';
			 ...
			 //  echo '<p class="small wow animated fadeInUp">';
	        // echo	"<b>"."answered by  :"."</b>".'<span class="glyphicon glyphicon-education">'."" . $row2["user"]. "";
			// echo '</p>';
	        // echo '<h4 class="subheading wow animated fadeInUp">';
	...
	?> 
	   <a href="profileallq.php#answer" class="btn btn-green">CLICK TO SEE ALL QUESTIONS<span class="price"></span></a> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<a href="searchform.php" class="btn btn-green">CLICK TO SEARCH QUESTIONS<span class="price"></span></a>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 text-left text-center-mobile wow animated fadeInUp contact-details">
				<h3 class="heading no-margin wow animated fadeInUp">Contact Lecturer</h3>
				<h4 class="subheading muted no-margin wow animated fadeInUp">Ask Something.</h4>
				<div class="details">
			...
			<form action="insertquestion.php" method="post" class="mail-form">
				<div class="col-md-6">
					<div class="row">
						<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-sm-12">
							<textarea name="question" class="form-control" rows="10" placeholder="Question. . ." data-validation="required"></textarea>
						</div>
					</div>
					<div class="row">
